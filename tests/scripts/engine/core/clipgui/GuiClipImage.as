package engine.core.clipgui
{
   ...
   public class GuiClipImage extends GuiClipImageBase
   {
       
      
      protected var _image:Image;
      
      public function GuiClipImage()
      {
         super();
      }
      ...
      protected function createImage(param1:Node) : Image
      {
         var _loc2_:* = null;
         ...
         {
            _loc2_ = new Image(AssetStorage.rsx.missing);
            StarlingClipNode.applyState(_loc2_,param1.state);
