package engine.core.clipgui
{
   ...
   import game.view.popup.clan.editicon.ColorPatternedImage;
   import starling.display.DisplayObject;
   import starling.textures.Texture;
   
   public class ClipColoredImage extends GuiClipImageBase
   {
       
      
      protected var _image:ColorPatternedImage;
      
      public function ClipColoredImage()
      {
         super();
      }
      
      public function get image() : ColorPatternedImage
      {
         return _image;
      }
      ...
      protected function createImage(param1:Node) : ColorPatternedImage
      {
         var _loc2_:* = null;
         var _loc3_:Texture = createTexture(param1.clip);
         if(_loc3_)
         {
            _loc2_ = new ColorPatternedImage(_loc3_);
            StarlingClipNode.applyState(_loc2_,param1.state);
         }
         else
         {
            _loc2_ = new ColorPatternedImage(AssetStorage.rsx.missing);
            StarlingClipNode.applyState(_loc2_,param1.state);
