   ...
   public class Scale9Image extends Sprite implements IValidating
   {
      ...
      public function validate() : void
      {
         ...
         if(this._propertiesChanged || this._layoutChanged || this._renderingChanged)
         {
            ...
            _loc4_ = this._textures.scale9Grid;
            _loc10_ = _loc4_.x * this._textureScale;
            _loc5_ = (this._frame.width - _loc4_.x - _loc4_.width) * this._textureScale;
            _loc1_ = _loc10_ + _loc5_;
            if(_loc1_ > this._width)
            {
               _loc2_ = this._width / _loc1_;
               _loc10_ = _loc10_ * _loc2_;
               _loc5_ = _loc5_ * _loc2_;
               _loc1_ = _loc10_ + _loc5_;
            }
            _loc7_ = this._width - _loc1_;
            _loc6_ = _loc4_.y * this._textureScale;
            _loc9_ = (this._frame.height - _loc4_.y - _loc4_.height) * this._textureScale;
            _loc8_ = _loc6_ + _loc9_;
            if(_loc8_ > this._height)
            {
               _loc2_ = this._height / _loc8_;
               _loc6_ = _loc6_ * _loc2_;
               _loc9_ = _loc9_ * _loc2_;
               _loc8_ = _loc6_ + _loc9_;
            }
            _loc3_ = this._height - _loc8_;
            if(_loc6_ > 0)
            {
               if(_loc10_ > 0)
               {
                  ...
                  helperImage.width = _loc10_;
                  helperImage.height = _loc6_;
                  helperImage.x = _loc10_ - helperImage.width;
                  helperImage.y = _loc6_ - helperImage.height;
