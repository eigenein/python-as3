package feathers.layout
{
   ...
   public class TiledColumnsLayout extends EventDispatcher implements IVirtualLayout
   {
      ...
      public function layout(param1:Vector.<DisplayObject>, param2:ViewPortBounds = null, param3:LayoutBoundsResult = null) : LayoutBoundsResult
      {
         ...
         {
            _loc6_ = _loc40_;
            _loc42_ = int((_loc40_ - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc45_ + this._verticalGap));
         }
         else if(_loc14_ === _loc14_ && _loc14_ < Infinity)
         {
            _loc6_ = _loc14_;
            _loc42_ = int((_loc14_ - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc45_ + this._verticalGap));
         }
         else
         {
            _loc42_ = _loc31_;
         ...
         else if(this._requestedRowCount > 0)
         {
            if(_loc6_ !== _loc6_)
            {
               _loc42_ = int(this._requestedRowCount);
         ...
         {
            _loc24_ = _loc33_;
            _loc38_ = (_loc33_ - this._paddingLeft - this._paddingRight + this._horizontalGap) / (_loc29_ + this._horizontalGap);
         }
         else if(_loc20_ === _loc20_ && _loc20_ < Infinity)
         {
            _loc24_ = _loc20_;
            _loc38_ = (_loc20_ - this._paddingLeft - this._paddingRight + this._horizontalGap) / (_loc29_ + this._horizontalGap);
         }
         else
         {
            _loc38_ = Math.ceil(_loc31_ / _loc42_);
         }
         if(_loc38_ < 1)
         {
            _loc38_ = 1;
         ...
         else if(this._requestedColumnCount > 0)
         {
            if(_loc24_ !== _loc24_)
            {
               _loc38_ = this._requestedColumnCount;
         ...
         while(_loc27_ < _loc31_)
         {
            ...
            if(!(_loc22_ is ILayoutableDisplayObject && !ILayoutableDisplayObject(_loc22_).includeInLayout))
            {
               if(_loc17_ != 0 && _loc27_ % _loc42_ == 0)
               {
               ...
               if(_loc17_ == _loc32_)
               {
                  ...
                  {
                     _loc11_ = _loc43_;
                     _loc15_ = Number(_loc41_ + _loc6_ * _loc37_);
         ...
         if(this._paging != "none")
         {
            ...
            _loc9_ = !!this._useVirtualLayout?this._discoveredItemsCache.length - 1:Number(_loc27_ - 1);
            this.applyHorizontalAlign(_loc23_,_loc7_,_loc9_,_loc10_,_loc4_);
            this.applyVerticalAlign(_loc23_,_loc7_,_loc9_,_loc16_,_loc25_);
            if(this.manageVisibility)
            {
         ...
         var _loc19_:* = Number(_loc11_ + _loc29_ + this._paddingRight);
         if(_loc24_ === _loc24_)
         {
         ...
         var _loc5_:* = _loc16_;
         if(_loc6_ === _loc6_ && this._paging == "vertical")
         {
      ...
      public function measureViewPort(param1:int, param2:ViewPortBounds = null, param3:Point = null) : Point
      {
         ...
         var _loc21_:Number = !!param2?param2.explicitWidth:NaN;
         var _loc29_:Number = !!param2?param2.explicitHeight:NaN;
         var _loc14_:* = _loc21_ !== _loc21_;
         var _loc10_:* = _loc29_ !== _loc29_;
         if(!_loc14_ && !_loc10_)
         {
            param3.x = _loc21_;
            param3.y = _loc29_;
         ...
         var _loc23_:Number = !!param2?param2.x:0;
         var _loc25_:Number = !!param2?param2.y:0;
         var _loc17_:Number = !!param2?param2.minWidth:0;
         var _loc7_:Number = !!param2?param2.minHeight:0;
         var _loc12_:Number = !!param2?param2.maxWidth:Infinity;
         var _loc8_:Number = !!param2?param2.maxHeight:Infinity;
         this.prepareTypicalItem();
         ...
         {
            _loc5_ = _loc29_;
            _loc30_ = int((_loc29_ - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc32_ + this._verticalGap));
         }
         else if(_loc8_ === _loc8_ && _loc8_ < Infinity)
         {
            _loc5_ = _loc8_;
            _loc30_ = int((_loc8_ - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc32_ + this._verticalGap));
         }
         else
         {
            _loc30_ = param1;
         ...
         else if(this._requestedRowCount > 0)
         {
            if(_loc5_ !== _loc5_)
            {
               _loc30_ = int(this._requestedRowCount);
               _loc5_ = Number(_loc30_ * (_loc32_ + this._verticalGap) - this._verticalGap - this._paddingTop - this._paddingBottom);
            }
            else if(_loc30_ > this._requestedRowCount)
            {
               _loc30_ = int(this._requestedRowCount);
            }
         }
         ...
         {
            _loc13_ = _loc21_;
            _loc27_ = (_loc21_ - this._paddingLeft - this._paddingRight + this._horizontalGap) / (_loc18_ + this._horizontalGap);
         }
         else if(_loc12_ === _loc12_ && _loc12_ < Infinity)
         {
            _loc13_ = _loc12_;
            _loc27_ = (_loc12_ - this._paddingLeft - this._paddingRight + this._horizontalGap) / (_loc18_ + this._horizontalGap);
         }
         else
         {
            _loc27_ = Math.ceil(param1 / _loc30_);
         }
         if(_loc27_ < 1)
         {
            _loc27_ = 1;
         ...
         else if(this._requestedColumnCount > 0)
         {
            if(_loc13_ !== _loc13_)
            {
               ...
               _loc13_ = Number(_loc27_ * (_loc18_ + this._horizontalGap) - this._horizontalGap - this._paddingLeft - this._paddingRight);
            }
            else if(_loc27_ > this._requestedColumnCount)
            {
               _loc27_ = this._requestedColumnCount;
            }
         }
         var _loc9_:Number = _loc30_ * (_loc32_ + this._verticalGap) - this._verticalGap + this._paddingTop + this._paddingBottom;
         var _loc31_:Number = _loc23_ + this._paddingLeft;
         var _loc24_:int = _loc27_ * _loc30_;
         var _loc26_:int = 0;
         var _loc20_:* = _loc24_;
         var _loc6_:* = _loc31_;
         _loc16_ = 0;
         ...
         {
            if(_loc16_ != 0 && _loc16_ % _loc30_ == 0)
            {
               _loc6_ = Number(_loc6_ + (_loc18_ + this._horizontalGap));
            }
            if(_loc16_ == _loc20_)
            {
               _loc26_++;
               _loc20_ = int(_loc20_ + _loc24_);
               if(this._paging == "horizontal")
               {
                  _loc6_ = Number(_loc31_ + _loc13_ * _loc26_);
               }
               else if(this._paging == "vertical")
               {
                  _loc6_ = _loc31_;
         ...
         var _loc11_:* = Number(_loc6_ + _loc18_ + this._paddingRight);
         if(_loc13_ === _loc13_)
         {
            if(this._paging == "vertical")
            {
            ...
            {
               _loc11_ = Number(Math.ceil(param1 / _loc24_) * _loc13_);
            }
         }
         var _loc4_:* = _loc9_;
         if(_loc5_ === _loc5_ && this._paging == "vertical")
         {
            _loc4_ = Number(Math.ceil(param1 / _loc24_) * _loc5_);
         }
         if(_loc14_)
         {
            _loc22_ = _loc11_;
      ...
      public function getScrollPositionForIndex(param1:int, param2:Vector.<DisplayObject>, param3:Number, param4:Number, param5:Number, param6:Number, param7:Point = null) : Point
      {
         ...
         var _loc19_:int = (param6 - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc20_ + this._verticalGap);
         if(_loc19_ < 1)
         {
            _loc19_ = 1;
         }
         else if(this._requestedRowCount > 0 && _loc19_ > this._requestedRowCount)
         {
            _loc19_ = this._requestedRowCount;
         }
         if(this._paging != "none")
         {
            _loc17_ = (param5 - this._paddingLeft - this._paddingRight + this._horizontalGap) / (_loc12_ + this._horizontalGap);
            if(_loc17_ < 1)
            {
               _loc17_ = 1;
            }
         ...
         {
            param7.x = this._paddingLeft + (_loc12_ + this._horizontalGap) * (int(param1 / _loc19_)) - Math.round((param5 - _loc12_) / 2);
            param7.y = 0;
         }
         return param7;
      }
      ...
      protected function getVisibleIndicesAtScrollPositionWithHorizontalPaging(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:Vector.<int>) : void
      {
         ...
         var _loc19_:int = (param3 - this._paddingLeft - this._paddingRight + this._horizontalGap) / (_loc16_ + this._horizontalGap);
         if(_loc19_ < 1)
         {
            _loc19_ = 1;
         }
         var _loc21_:int = (param4 - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc23_ + this._verticalGap);
         if(_loc21_ < 1)
         {
            _loc21_ = 1;
         }
         else if(this._requestedRowCount > 0 && _loc21_ > this._requestedRowCount)
         {
            _loc21_ = this._requestedRowCount;
         }
         var _loc18_:int = _loc19_ * _loc21_;
         var _loc11_:* = int(_loc18_ + 2 * _loc21_);
         if(_loc11_ > param5)
         {
            _loc11_ = param5;
         }
         var _loc12_:int = Math.round(param1 / param3);
         var _loc22_:int = _loc12_ * _loc18_;
         ...
         if(_loc9_ < param3)
         {
            ...
            {
               _loc24_ = Number(Math.round((param3 - this._paddingLeft - this._paddingRight - _loc9_) / 2));
         ...
         var _loc13_:* = Number(param1 - _loc25_);
         if(_loc13_ < 0)
         {
            _loc13_ = Number(-_loc13_ - this._paddingRight - _loc24_);
            if(_loc13_ < 0)
            {
               _loc13_ = 0;
            }
            _loc7_ = -Math.floor(_loc13_ / (_loc16_ + this._horizontalGap)) - 1;
            _loc22_ = _loc22_ + _loc7_ * _loc21_;
         }
         else if(_loc13_ > 0)
         {
            _loc13_ = Number(_loc13_ - this._paddingLeft - _loc8_);
            if(_loc13_ < 0)
            {
               _loc13_ = 0;
            }
         ...
         var _loc20_:* = int(_loc22_ + _loc11_);
         if(_loc20_ > param5)
         {
            _loc20_ = param5;
         }
      ...
      protected function getVisibleIndicesAtScrollPositionWithVerticalPaging(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:Vector.<int>) : void
      {
         ...
         var _loc22_:int = (param3 - this._paddingLeft - this._paddingRight + this._horizontalGap) / (_loc18_ + this._horizontalGap);
         if(_loc22_ < 1)
         {
            _loc22_ = 1;
         }
         var _loc24_:int = (param4 - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc27_ + this._verticalGap);
         if(_loc24_ < 1)
         {
            _loc24_ = 1;
         }
         else if(this._requestedRowCount > 0 && _loc24_ > this._requestedRowCount)
         {
            _loc24_ = this._requestedRowCount;
         }
         var _loc21_:int = _loc22_ * _loc24_;
         var _loc11_:* = int(_loc21_ + 2 * _loc24_);
         if(_loc11_ > param5)
         {
            _loc11_ = param5;
         }
         var _loc12_:int = Math.round(param2 / param4);
         var _loc26_:int = _loc12_ * _loc21_;
         ...
         var _loc15_:* = Number(param2 - _loc28_);
         if(_loc15_ < 0)
         {
            _loc15_ = Number(-_loc15_ - this._paddingBottom - _loc9_);
            if(_loc15_ < 0)
            {
               _loc15_ = 0;
            }
            _loc20_ = -Math.floor(_loc15_ / (_loc18_ + this._verticalGap)) - 1;
            _loc26_ = _loc26_ + (-_loc21_ + _loc22_ + _loc20_);
         }
         else if(_loc15_ > 0)
         {
            _loc15_ = Number(_loc15_ - this._paddingTop - _loc7_);
            if(_loc15_ < 0)
            {
               _loc15_ = 0;
            }
      ...
      protected function getVisibleIndicesAtScrollPositionWithoutPaging(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:Vector.<int>) : void
      {
         ...
         var _loc18_:int = (param4 - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc20_ + this._verticalGap);
         if(_loc18_ < 1)
         {
            _loc18_ = 1;
         }
         else if(this._requestedRowCount > 0 && _loc18_ > this._requestedRowCount)
         {
            _loc18_ = this._requestedRowCount;
         }
         var _loc15_:int = Math.ceil((param3 + this._horizontalGap) / (_loc10_ + this._horizontalGap)) + 1;
         var _loc14_:* = int(_loc18_ * _loc15_);
         if(_loc14_ > param5)
         {
            _loc14_ = param5;
         }
         var _loc12_:int = 0;
         var _loc8_:Number = Math.ceil(param5 / _loc18_) * (_loc10_ + this._horizontalGap) - this._horizontalGap;
         if(_loc8_ < param3)
         {
            if(this._verticalAlign == "bottom")
            {
         ...
         var _loc17_:int = -_loc12_ + Math.floor((param1 - this._paddingLeft + this._horizontalGap) / (_loc10_ + this._horizontalGap));
         var _loc19_:int = _loc17_ * _loc18_;
         if(_loc19_ < 0)
         {
            _loc19_ = 0;
         }
         var _loc16_:* = int(_loc19_ + _loc14_);
         if(_loc16_ > param5)
         {
            _loc16_ = param5;
         }
