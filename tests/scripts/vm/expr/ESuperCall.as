package vm.expr
{
   ...
   public class ESuperCall extends Expr
   {
       
      
      public var params:Array;
      
      public function ESuperCall(param1:Array = undefined)
      {
      ...
      override public function resolve() : *
      {
         ...
         var _loc1_:* = Expr.context.resolve("super");
         if(!_loc1_.hasOwnProperty("new"))
         {
            return null;
         }
         var _loc2_:Array = [];
         ...
         return _loc1_["new"].apply(null,_loc2_);
      }
      
      override public function print() : String
      {
         var _loc5_:* = null as Expr;
         var _loc1_:String = "super(";
