package battle.hooks
{
   ...
   public class GenericHook_battle_proxy_idents_HeroAnimationIdent
   {
       
      
      public var listeners:GenericHookListener;
      
      public function GenericHook_battle_proxy_idents_HeroAnimationIdent()
      {
      }
      ...
      public function call(param1:HeroAnimationIdent) : HeroAnimationIdent
      {
