package game.view.specialoffer.bundle
{
   ...
   public class ResourceBundleBirthday2018SpecialOfferPopup extends ResourceBundleSpecialOfferPopup
   {
       
      
      public function ResourceBundleBirthday2018SpecialOfferPopup(param1:ResourceBundleSpecialOfferPopupMediator, param2:RsxGuiAsset = null)
      {
         super(param1,param2);
      }
      ...
      {
         return AssetStorage.rsx.asset_bundle.create(Bundle2PopupClip,"dialog_bundle_resource_4_purple");
      }
