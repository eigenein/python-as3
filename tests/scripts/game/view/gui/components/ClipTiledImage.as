package game.view.gui.components
{
   ...
   public class ClipTiledImage extends GuiClipImageBase
   {
       
      
      protected var _image:TiledImage;
      
      public function ClipTiledImage()
      {
         super();
      }
      
      public function get image() : TiledImage
      {
         return _image;
      }
      ...
      protected function createImage(param1:Node) : TiledImage
      {
         var _loc2_:* = null;
         var _loc3_:Texture = createTexture(param1.clip);
         if(_loc3_)
         {
            _loc2_ = new TiledImage(_loc3_);
            StarlingClipNode.applyState(_loc2_,param1.state);
         }
         else
         {
            _loc2_ = new TiledImage(AssetStorage.rsx.missing);
            StarlingClipNode.applyState(_loc2_,param1.state);
