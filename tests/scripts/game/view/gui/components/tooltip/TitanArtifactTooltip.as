package game.view.gui.components.tooltip
{
   ...
   public class TitanArtifactTooltip extends TooltipTextView
   {
      ...
      public function TitanArtifactTooltip()
      {
         super();
      }
      ...
      {
         var _loc2_:PlayerTitanArtifact = param1 as PlayerTitanArtifact;
      ...
      private function handler_update(param1:PlayerTitanArtifact) : void
      {
