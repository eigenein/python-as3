package game.view.gui.components.tooltip
{
   ...
   public class TitanArtifactFragmentTooltip extends TooltipTextView
   {
       
      
      private var artifact:TitanArtifactDescription;
      
      private var params:GameLabel;
      
      public function TitanArtifactFragmentTooltip()
      {
         super();
      }
      ...
      {
         var _loc2_:TitanArtifactDescription = param1 as TitanArtifactDescription;
      ...
      private function update() : void
      {
         ...
         addChild(_label);
         params.text = ColorUtils.hexToRGBFormat(16573879) + artifact.descText;
         addChild(params);
      }
   }
}
