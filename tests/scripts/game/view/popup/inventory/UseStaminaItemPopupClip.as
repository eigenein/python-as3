package game.view.popup.inventory
{
   ...
   public class UseStaminaItemPopupClip extends GuiClipNestedContainer
   {
      ...
      public var tf_use_cost:ClipLabel;
      
      public var tf_use_cost_base:ClipLabel;
      
      public var tf_use_for_label:ClipLabel;
      
      public var tf_use_for_label_base:ClipLabel;
      
      public var icon_stamina:GuiClipImage;
      
      public var icon_stamina_base:GuiClipImage;
      ...
      public var layout_use_stamina:ClipLayout;
      
      public var layout_use_stamina_base:ClipLayout;
      
      public var marker_slider_container:ClipLayout;
      
      public var layout_counter_slider:ClipLayout;
      
      public function UseStaminaItemPopupClip()
      {
         ...
         tf_use_cost = new ClipLabel(true);
         tf_use_cost_base = new ClipLabel(true);
         tf_use_for_label = new ClipLabel(true);
         tf_use_for_label_base = new ClipLabel(true);
         icon_stamina = new GuiClipImage();
         icon_stamina_base = new GuiClipImage();
         ...
         layout_use_stamina = ClipLayout.horizontalCentered(4,tf_use_for_label,icon_stamina,tf_use_cost);
         layout_use_stamina_base = ClipLayout.horizontal(4,tf_use_for_label_base,icon_stamina_base,tf_use_cost_base);
