package game.view.popup.summoningcircle.reward
{
   ...
   public class SummoningCircleRewardExtendedPopup extends ClipBasedPopup
   {
       
      
      private var mediator:SummoningCircleRewardExtendedPopupMediator;
      
      public function SummoningCircleRewardExtendedPopup(param1:SummoningCircleRewardExtendedPopupMediator)
      {
         super(param1);
      ...
      override protected function initialize() : void
      {
         ...
         _loc3_.title = Translate.translate("UI_DIALOG_SUMMONING_CIRCLE");
         _loc3_.tf_caption.text = Translate.translate("UI_POPUP_CHEST_REWARD");
