package game.view.popup.resource
{
   ...
   public class CopyofNotEnoughResourcePopup extends ClipBasedPopup
   {
       
      
      private var mediator:CopyofNotEnoughResourcePopupMediator;
      
      protected var clip:NotEnoughResourcePopupClip;
      
      private var _signal_okClose:Signal;
      
      public function CopyofNotEnoughResourcePopup(param1:CopyofNotEnoughResourcePopupMediator)
      {
         _signal_okClose = new Signal(CopyofNotEnoughResourcePopup);
         super(null);
