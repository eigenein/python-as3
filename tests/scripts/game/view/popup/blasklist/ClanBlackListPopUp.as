package game.view.popup.blasklist
{
   ...
   public class ClanBlackListPopUp extends ClipBasedPopup
   {
       
      
      private var mediator:ClanBlackListPopUpMediator;
      
      private var clip:BlackListPopUpClip;
      
      private var blackList:GameScrolledList;
      
      public function ClanBlackListPopUp(param1:ClanBlackListPopUpMediator)
      {
         super(param1);
      ...
      override protected function initialize() : void
      {
         ...
         clip.tf_title.text = Translate.translate("UI_POPUP_CLAN_BLACK_LIST_TITLE");
         clip.tf_desc.text = Translate.translate("UI_POPUP_CLAN_BLACK_LIST_DESC");
