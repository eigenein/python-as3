package game.view.popup.artifacts
{
   ...
   public class TitanArtifactLevelUpClip extends GuiClipNestedContainer
   {
      ...
      public function TitanArtifactLevelUpClip()
      {
      ...
      public function updateState() : void
      {
         ...
         {
            if(mediator.artifactNextLevelCost.outputDisplayFirst.item is ConsumableDescription)
            {
               tf_label_level_up_1.text = Translate.translate("UI_DIALOG_TITAN_ARTIFACTS_LEVEL_UP_CONSUMABLE_DESC");
            }
            else
            {
               tf_label_level_up_1.text = Translate.translate("UI_DIALOG_TITAN_ARTIFACTS_LEVEL_UP_GOLD_DESC");
            }
            ...
            layout_consumable_cost.readjustLayout();
            layout_star_money_cost.readjustLayout();
         }
      }
