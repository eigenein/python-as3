package game.view.popup.artifacts
{
   ...
   public class TitanArtifactEvolveClip extends GuiClipNestedContainer
   {
      ...
      public function TitanArtifactEvolveClip()
      {
      ...
      public function updateState() : void
      {
         ...
         {
            tf_desc.text = Translate.translateArgs("UI_DIALOG_TITAN_ARTIFACTS_NOT_AVALIABLE",mediator.artifactMinTitanLevel);
         }
