package game.view.popup.artifacts
{
   ...
   public class HeroArtifactListRendererClip extends GuiClipNestedContainer
   {
       
      
      public var item:PlayerHeroArtifactItemRenderer;
      ...
      public function HeroArtifactListRendererClip()
      {
         item = new PlayerHeroArtifactItemRenderer();
