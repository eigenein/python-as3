package game.view.popup.artifactinfo
{
   ...
   public class TitanSpiritArtifactInfoPopupMediator extends PopupMediator
   {
       
      
      public var artifact:TitanArtifactDescription;
      
      public function TitanSpiritArtifactInfoPopupMediator(param1:Player, param2:TitanArtifactDescription)
      {
         super(param1);
      ...
      {
         _popup = new TitanSpiritArtifactInfoPopup(this);
         return _popup;
      }
