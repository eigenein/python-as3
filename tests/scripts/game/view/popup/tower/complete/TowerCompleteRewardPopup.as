package game.view.popup.tower.complete
{
   ...
   public class TowerCompleteRewardPopup extends ClipBasedPopup
   {
       
      
      private var mediator:TowerCompleteRewardPopupMediator;
      
      public function TowerCompleteRewardPopup(param1:TowerCompleteRewardPopupMediator)
      {
         super(param1);
      ...
      override protected function initialize() : void
      {
         ...
         _loc3_.title = Translate.translate("UI_DIALOG_TOWER_COMPLETE_TITLE");
         _loc3_.tf_caption.text = Translate.translate("UI_DIALOG_TOWER_COMPLETE_REWARD_TITLE");
         ...
         _loc2_.itemRendererType = TowerRewardItemRenderer;
