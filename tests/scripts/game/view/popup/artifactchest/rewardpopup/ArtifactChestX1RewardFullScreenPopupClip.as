package game.view.popup.artifactchest.rewardpopup
{
   ...
   public class ArtifactChestX1RewardFullScreenPopupClip extends ArtifactChestRewardFullScreenPopupClipBase
   {
      ...
      public const layout_special_offer:ClipLayout = ClipLayout.none();
      
      public function ArtifactChestX1RewardFullScreenPopupClip()
      {
         super();
      }
