package game.view.popup.artifactchest.rewardpopup
{
   ...
   public class ArtifactChestRewardPopupItemRenderer extends ListItemRenderer implements ITooltipSource
   {
      ...
      public function ArtifactChestRewardPopupItemRenderer()
      {
         super();
      ...
      override protected function initialize() : void
      {
         ...
         AssetStorage.rsx.popup_theme.initGuiClip(_tileClip,"inventory_tile2");
