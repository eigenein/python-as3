package game.view.popup.titanspiritartifact
{
   ...
   import game.view.popup.artifacts.ClipListItemArtifactCraftRecipe;
   import game.view.popup.artifacts.HeroArtifactUpgradeTitleClip;
   
   public class TitanSpiritArtifactEvolveClip extends GuiClipNestedContainer
   {
      ...
      public function TitanSpiritArtifactEvolveClip()
      {
      ...
      public function updateState() : void
      {
         ...
         {
            title.tf_title.text = Translate.translate("UI_DIALOG_TITAN_SPIRIT_ARTIFACT_TOTEM_EVOLUTION");
         }
         else
         {
            title.tf_title.text = Translate.translate("UI_DIALOG_TITAN_SPIRIT_ARTIFACT_TOTEM_AWAKENING");
         }
         tf_desc.graphics.visible = !mediator.artifactIsAvaliable || mediator.artifactMaxStars;
         if(mediator.artifactMaxStars)
         {
            tf_desc.text = Translate.translate("UI_DIALOG_TITAN_SPIRIT_ARTIFACT_MAX_STARS");
         }
