package game.view.popup.shop.special
{
   ...
   public class SpecialShopMiniHeroList extends List
   {
      ...
      public function SpecialShopMiniHeroList(param1:ClipLayout, param2:ClipButton, param3:ClipButton, param4:int = 9)
      {
         super();
         ...
         itemRendererType = SpecialShopHeroListRenderer;
      }
      ...
      override public function set dataProvider(param1:ListCollection) : void
      {
         ...
         if(dataProvider.length <= itemCount)
         {
            width = NaN;
      ...
      private function list_rendererAddHandler(param1:Event, param2:SpecialShopHeroListRenderer) : void
      {
         param2.signal_select.add(handler_itemSelect);
      }
      
      private function handler_itemSelect(param1:SpecialShopHeroListRenderer) : void
      {
         selectedIndex = param1.index;
      }
      
      private function list_rendererRemoveHandler(param1:Event, param2:SpecialShopHeroListRenderer) : void
      {
