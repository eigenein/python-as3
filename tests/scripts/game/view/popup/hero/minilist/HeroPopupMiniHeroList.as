package game.view.popup.hero.minilist
{
   ...
   public class HeroPopupMiniHeroList extends List
   {
      ...
      public function HeroPopupMiniHeroList(param1:ClipLayout, param2:ClipButton, param3:ClipButton, param4:int = 9)
      {
         super();
         ...
         itemRendererType = HeroPopupMiniHeroListItem;
      }
      ...
      private function list_rendererAddHandler(param1:Event, param2:HeroPopupMiniHeroListItem) : void
      {
         param2.signal_select.add(handler_itemSelect);
      }
      
      private function handler_itemSelect(param1:HeroPopupMiniHeroListItem) : void
      {
         selectedIndex = param1.index;
      }
      
      private function list_rendererRemoveHandler(param1:Event, param2:HeroPopupMiniHeroListItem) : void
      {
