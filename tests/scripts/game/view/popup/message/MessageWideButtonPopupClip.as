package game.view.popup.message
{
   ...
   public class MessageWideButtonPopupClip extends GuiClipNestedContainer
   {
      ...
      public function MessageWideButtonPopupClip()
      {
         ...
         layout_text = ClipLayout.verticalMiddleCenter(8,tf_header,line,tf_message,button_ok);
         super();
      }
   }
}
