package game.command.rpc.rating
{
   ...
   public class CommandRatingTopGetResultClanDungeonEntry extends CommandRatingTopGetResultEntry
   {
       
      
      private var _clan:ClanBasicInfoValueObject;
      
      public function CommandRatingTopGetResultClanDungeonEntry(param1:int, param2:Object, param3:Object)
      {
         var _loc4_:int = param2.dungeonActivity;
      ...
      override public function get ratingValueLabel() : String
      {
         ...
         return Translate.translateArgs("UI_DIALOG_RATING_TYPE_CLAN_DUNGEON_ACTIVITY",DataStorage.rule.clanRule.topPeriod);
      }
