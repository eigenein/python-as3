package game.command.rpc.artifact
{
   ...
   public class CommandTitanArtifactEvolve extends CostCommand
   {
      ...
      public function CommandTitanArtifactEvolve(param1:PlayerTitanEntry, param2:PlayerTitanArtifact)
      {
         super();
         isImmediate = true;
         this.titan = param1;
         this.artifact = param2;
         rpcRequest = new RpcRequest("titanArtifactEvolve");
      ...
      override public function clientExecute(param1:Player) : void
      {
         ...
         param1.titans.titanArtifactEvolveStar(titan,artifact);
         ...
         Tutorial.events.triggerEvent_titanArtifactEvolve(artifact);
      }
   }
}
