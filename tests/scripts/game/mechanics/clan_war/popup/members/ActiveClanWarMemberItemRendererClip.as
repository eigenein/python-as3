package game.mechanics.clan_war.popup.members
{
   ...
   public class ActiveClanWarMemberItemRendererClip extends GuiClipNestedContainer
   {
      ...
      public function ActiveClanWarMemberItemRendererClip()
      {
         nickname_tf = new ClipLabel();
         attempts_tf = new ClipLabel();
