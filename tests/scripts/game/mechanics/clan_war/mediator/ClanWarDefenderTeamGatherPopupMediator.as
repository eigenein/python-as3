package game.mechanics.clan_war.mediator
{
   ...
   public class ClanWarDefenderTeamGatherPopupMediator extends TeamGatherPopupMediator
   {
       
      
      private var _isTitanTeam:Boolean;
      
      public function ClanWarDefenderTeamGatherPopupMediator(param1:Player, param2:Vector.<UnitDescription>, param3:Boolean)
      {
      ...
      {
         player.heroes.teamData.saveClanWarsTeam(descriptionList,true,isTitanTeam);
