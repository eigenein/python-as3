package game.mechanics.expedition.mediator
{
   ...
   import game.mechanics.expedition.popup.ExpeditionListPopup;
   ...
   public class ExpeditionListPopupMediator extends PopupMediator implements IExpeditionValueObjectActions
   {
      ...
      public function ExpeditionListPopupMediator(param1:Player)
      {
      ...
      {
         _popup = new ExpeditionListPopup(this);
         return new ExpeditionListPopup(this);
      }
      ...
      {
         var _loc2_:RewardPopup = new RewardPopup(param1.reward.outputDisplay,"expeditionReward");
         _loc2_.header = Translate.translate("UI_DIALOG_EXPEDITION_REWARD_POPUP_TITLE");
         _loc2_.label = "";
         _loc2_.open();
      }
   }
