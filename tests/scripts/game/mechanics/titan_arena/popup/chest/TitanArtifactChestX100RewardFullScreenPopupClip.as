package game.mechanics.titan_arena.popup.chest
{
   ...
   import game.view.popup.artifactchest.rewardpopup.ArtifactChestRewardPopupClipMulti100;
   import game.view.popup.artifactchest.rewardpopup.ArtifactChestRewardPopupItemRenderer;
   import game.view.popup.artifactchest.rewardpopup.ArtifactChestRewardPopupItemTile;
   import starling.core.Starling;
   import starling.display.DisplayObject;
   import starling.display.DisplayObjectContainer;
   
   public class TitanArtifactChestX100RewardFullScreenPopupClip extends TitanArtifactChestRewardFullScreenPopupClipBase
   {
      ...
      public function TitanArtifactChestX100RewardFullScreenPopupClip()
      {
      ...
      override public function setNode(param1:Node) : void
      {
         ...
         multi_reward_list_100.tf_reward_title.text = Translate.translate("UI_DIALOG_TITAN_ARTIFACT_CHEST_REWARD");
      }
      ...
      override public function dropItem(param1:ArtifactFlyingDropLayer, param2:InventoryItem, param3:int) : void
      {
         ...
         var _loc8_:Number = 2.1 + (param3 % 10 * 0.009 + int(param3 / 10) * 0.2) / 2 + additionalStartDelay;
      ...
      private function itemTilesSort(param1:ArtifactChestRewardPopupItemRenderer, param2:ArtifactChestRewardPopupItemRenderer) : int
      {
         if(param1.tileClip.data.amount != param2.tileClip.data.amount)
         {
            return param1.tileClip.data.amount - param2.tileClip.data.amount;
         }
         return param1.tileClip.data.id - param2.tileClip.data.id;
      }
   }
}
