package game.mechanics.titan_arena.popup.halloffame
{
   ...
   public class TitanArenaHallOfFameGoldCupHolderRendererClip extends GuiClipNestedContainer
   {
      ...
      public function TitanArenaHallOfFameGoldCupHolderRendererClip()
      {
      ...
      {
         tf_place.text = param1.place.toString();
