package game.mechanics.titan_arena.mediator.rating
{
   import game.mediator.gui.popup.rating.RatingPopupMediator;
   import game.model.user.Player;
   
   public class TitanArenaRatingPopupMediator extends RatingPopupMediator
   {
       
      
      public function TitanArenaRatingPopupMediator(param1:Player)
      {
         super(param1);
      ...
      {
         return new <String>["titanArenaCurrent","titanArenaPrevious"];
      }
