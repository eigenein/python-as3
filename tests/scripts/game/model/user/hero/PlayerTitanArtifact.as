package game.model.user.hero
{
   ...
   public class PlayerTitanArtifact
   {
       
      
      private var _desc:TitanArtifactDescription;
      ...
      public function PlayerTitanArtifact()
      {
         _signal_evolve = new Signal(PlayerTitanArtifact);
         _signal_levelUp = new Signal(PlayerTitanArtifact);
         super();
      }
      
      public function get desc() : TitanArtifactDescription
      {
         return _desc;
      }
      
      public function set desc(param1:TitanArtifactDescription) : void
      {
         _desc = param1;
      }
      ...
      public function evolve() : void
      {
         ...
         signal_evolve.dispatch(this);
      }
      
      public function levelUp() : void
      {
         level = Math.min(level + 1,desc.artifactTypeData.levels.length);
         signal_levelUp.dispatch(this);
      }
      
      public function canEvolve(param1:Player, param2:PlayerTitanEntry) : Boolean
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
      ...
      public function canLevelUp(param1:Player, param2:PlayerTitanEntry) : Boolean
      {
         var _loc3_:* = null;
         if(_desc.artifactTypeData.minHeroLevel <= param2.level.level)
         {
